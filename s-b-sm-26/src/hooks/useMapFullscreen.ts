...
/**
 * Fullscreen map: Fullscreen API in the browser, CSS overlay in Capacitor WebView.
 * Android back / browser back exits via a dummy history entry.
 */
  ...
  useEffect(() => {
    ...
    if (fullscreen) {
      ...
      void el?.requestFullscreen?.().catch(() => {
        /* Capacitor WebView: CSS fixed inset-0 is the fallback */
      });
      return;
    }
