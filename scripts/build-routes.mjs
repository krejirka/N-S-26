...
const SEGMENTS = [
  ...
  { id: "furoy_graddis", from: "furoy", to: "graddis", kind: "road", phase: "tam", dayLabel: "10" },
  { id: "graddis_myrkulla", from: "graddis", to: "myrkulla", kind: "road", phase: "tam", dayLabel: "11" },
  { id: "myrkulla_valkalampi", from: "myrkulla", to: "valkalampi", kind: "road", phase: "zpět", dayLabel: "15" },
  { id: "valkalampi_vimmerby", from: "valkalampi", to: "vimmerby", kind: "road", phase: "zpět", dayLabel: "16" },
...
const DAY_SEGMENTS = {
  ...
  13: [],
  14: [],
  15: ["myrkulla_valkalampi"],
  16: ["valkalampi_vimmerby"],
